...
---------------
        ...
        br.player.mode.Interrupt = br.data.settings[br.selectedSpec].toggles["Cleave"]
...
local function actionList_Stealthed()
    ...
    -- Action List - Build
        ...
        -- end
            ...
            if (not talent.subterfuge or not (cd.vanish.remain() == 0 and cd.vendetta.remain() <=4) or mode.special == 2)  then
